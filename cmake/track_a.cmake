# Track A built the way Track B is: CMake and this project's arm-gcc.
#
# Before this file, Track A was built by `arduino-cli`, which bundles
# **GCC 4.8.3 (2014q1)**, while Track B was on **xPack GCC 15.2.1**.
...
# both while answering the question "can your bench build this target".
#
...
# sketches/bringup/, so the sketch directory stays exactly what an
# Arduino IDE would compile and the two can be compared at any time.
